...
<div class="main-menu">
	<header class="header">
		<a href="#" class="logo"><i class="ico ti-notepad"></i>Translate Ijazah</a>
	...
	<div class="pull-right">
		<div class="ico-item">
			<ul class="sub-ico-item">
				<li><a href="proses.php?logout">Log Out</a></li>
			</ul>
			<!-- /.sub-ico-item -->
		</div>
	</div>
